...
export function SocialProof() {
  return (
    <section className="py-10 md:py-16 bg-white border-y border-[#CBD2DC]/30">
      <div className="max-w-[1280px] mx-auto px-5 md:px-20">
        {/* Logos Row */}
        <div className="flex items-center gap-8 md:gap-16 md:justify-center overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
          {logos.map((logo) => (
            <div
              key={logo.name}
              className="flex-shrink-0 text-[#1E335F] opacity-50 hover:opacity-100 transition-opacity duration-300"
              ...
              >
                <div className="cursor-default">
                  <StatCounter
                    ...
                    suffix={suffix}
                    decimals={decimals}
                    className="[&_span]:text-[#26437A] [&_p]:text-[#1E335F]/60 [&_p]:font-medium [&_p]:mt-0"
                  />
                </div>
              </RichTooltip>
            );
