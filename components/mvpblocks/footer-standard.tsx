...
export default function FooterStandard() {
  ...
  return (
    <footer className="mt-20 w-full bg-background relative z-10">
      ...
      <div className="relative w-full px-5">
          ...
          <div className="space-y-6 lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3">
              {/* <Image
                ...
                className="size-10"
              /> */}
              <span className="font-playfair text-2xl font-bold text-primary tracking-tight">Creative Core</span>
            </Link>
        ...
        <div className="text-muted-foreground container m-auto flex flex-col items-center justify-between gap-4 p-4 text-xs md:flex-row md:px-0 md:text-sm">
          <p className="">
            &copy; {currentYear} Creative Core | All rights reserved
          </p>
